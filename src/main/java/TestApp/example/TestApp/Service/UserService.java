...
import TestApp.example.TestApp.Exceptions.UserAlreadyExistException;
import TestApp.example.TestApp.Registration.EmailSender;
import TestApp.example.TestApp.Repository.UserRepository;
import TestApp.example.TestApp.UserDto.UserDto;
...
public class UserService implements UserDetailsService {
    ...
    public void updateUser(Long userId, UserDto userData) {
        ...
        userRepository.findById(userId).map(existingUser -> updateEntity(userData, existingUser))
    ...
    public void createToken(User user){
        ...
        ConfirmationToken confirmationToken = new ConfirmationToken(
                token, LocalDateTime.now().plusMinutes(10),
                LocalDateTime.now(),
                user);
